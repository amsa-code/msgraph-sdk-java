...
/**
 * The interface for the Base Planner Plan With Reference Request.
 */
public interface IBasePlannerPlanWithReferenceRequest extends IHttpRequest {
    ...
    IBasePlannerPlanWithReferenceRequest select(final String value);

    IBasePlannerPlanWithReferenceRequest expand(final String value);
