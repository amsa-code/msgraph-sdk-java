...
/**
 * The interface for the Base Planner Plan Reference Request.
 */
public interface IBasePlannerPlanReferenceRequest extends IHttpRequest {
     ...
     */
    IBasePlannerPlanReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IBasePlannerPlanReferenceRequest expand(final String value);
