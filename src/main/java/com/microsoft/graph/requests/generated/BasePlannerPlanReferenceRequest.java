...
/**
 * The class for the Base Planner Plan Reference Request.
 */
public class BasePlannerPlanReferenceRequest extends BaseRequest implements IBasePlannerPlanReferenceRequest {
     ...
     */
    public BasePlannerPlanReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
