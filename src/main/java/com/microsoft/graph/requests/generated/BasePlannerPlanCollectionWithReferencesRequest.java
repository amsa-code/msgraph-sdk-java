...
/**
 * The class for the Base Planner Plan Collection With References Request.
 */
public class BasePlannerPlanCollectionWithReferencesRequest extends BaseCollectionRequest<BasePlannerPlanCollectionResponse, IPlannerPlanCollectionPage> implements IBasePlannerPlanCollectionWithReferencesRequest {
     ...
     */
    public BasePlannerPlanCollectionWithReferencesRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IPlannerPlanCollectionWithReferencesPage buildFromResponse(final BasePlannerPlanCollectionResponse response) {
