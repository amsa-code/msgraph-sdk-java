...
/**
 * The class for the Base Planner Plan Collection With References Request Builder.
 */
public class BasePlannerPlanCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IBasePlannerPlanCollectionWithReferencesRequestBuilder {
     ...
     */
    public BasePlannerPlanCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
