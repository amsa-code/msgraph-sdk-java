...
/**
 * The interface for the Base Planner Task Reference Request.
 */
public interface IBasePlannerTaskReferenceRequest extends IHttpRequest {
     ...
     */
    IBasePlannerTaskReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IBasePlannerTaskReferenceRequest expand(final String value);
