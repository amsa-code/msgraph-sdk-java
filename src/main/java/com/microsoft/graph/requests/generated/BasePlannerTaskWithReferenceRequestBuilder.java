...
/**
 * The class for the Base Planner Task With Reference Request Builder.
 */
public class BasePlannerTaskWithReferenceRequestBuilder extends BaseRequestBuilder implements IBasePlannerTaskWithReferenceRequestBuilder {
     ...
     */
    public BasePlannerTaskWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
