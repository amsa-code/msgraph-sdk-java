...
/**
 * The class for the Base Planner Task Collection With References Request Builder.
 */
public class BasePlannerTaskCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IBasePlannerTaskCollectionWithReferencesRequestBuilder {
     ...
     */
    public BasePlannerTaskCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
